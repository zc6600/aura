...
module Aura
  module Generators
    class AppBase < Thor::Group
      ...
      def self.add_shared_options_for(_name)
        class_option :template, type: :string, aliases: "-m", desc: "Path to some application template (can be a filesystem path or URL)"
        class_option :project_template, type: :string, aliases: "-T",
                                        desc: "Project template name under lib/aura/generators/aura/app/templates/projects"
